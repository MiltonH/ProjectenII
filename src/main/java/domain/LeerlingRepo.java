...
//    }
    ...
    public void updateLeerlingList(List<Leerling> list, HBox knoppen, ImageView view, InlogPaneel panel, ProgressIndicator pi, ImageView fail) {
...
//    }
    ...
    public void Synchroniseer(HBox knoppen, ImageView view, InlogPaneel panel, ImageView fail) {
        ProgressIndicator pi = new ProgressIndicator();
        if (knoppen.getChildren().contains(view)) {
            knoppen.getChildren().remove(view);
        }
        if (knoppen.getChildren().contains(fail)) {
            knoppen.getChildren().remove(fail);
        }
...
//        System.out.println(putList.size());
        ...
        //
        updateLeerlingList(leerlingList, knoppen, view, panel, pi, fail);
